    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
              <a href="index.html" class="text-black"><span class="text-primary">Manos Solidarias</a>
            </div>
              ...
              <nav class="site-navigation text-center ml-auto" role="navigation">
                ...
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  ...
                  <li><a href="#discover-section" class="nav-link">Galería</a></li>
                  <li><a href="#donate-section" class="nav-link">Donaciones</a></li>
                  <li><a href="#blog-section" class="nav-link">Contacto</a></li>
                </ul>
              </nav>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-5 text-center">
            <h2 class="text-white mb-4">¡Haz una donación! Podrías cambiar una vida</h2>
            <p><a href="#" class="btn btn-primary px-4 py-3 btn-block">Donar</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <h2 class="text-black section-title text-uppercase">Contáctanos</h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
